...
{block name=title}Administration Registration{/block}
{block name=head}
...
{block name=body}
    <div style="max-width: 660px;padding: 15px;margin: 0 auto;">
        ...
        <p>
            This screen will only be available until one
    ...
    <form class="form-register" method="post" action="/register">
        <label for="inputEmail" class="sr-only">Administrator Email address</label>
        <input type="email" id="inputEmail" name="inputEmail" class="form-control" placeholder="Administrator Email address" required
               autofocus>
